...
(function($) {
    ...
    $.fn.Tabledit = function(options) {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        if (settings.sendButton) {
                            sendButton = '<button type="button" class="tabledit-send-button ' + settings.buttons.send.class + '" style="float: none;">' + settings.buttons.send.html + '</button>';
                        }
                        ...
                        var toolbar = '<div class="tabledit-toolbar ' + settings.toolbarClass + '" style="text-align: left;">\n\
                                           <div class="' + settings.groupClass + '" style="float: none;">' + editButton + deleteButton + sendButton + '</div>\n\
                                           ' + saveButton + '\n\
                                           ' + confirmButton + '\n\
                                           ' + restoreButton + '\n\
                                       </div></div>';
        ...
        if (settings.sendButton) {
            /**
             * Lähetä tiedosto-napin toiminto
             *
             * @param {object} event
             */
            $table.on('click', 'button.tabledit-send-button', function(event) {
                if (event.handled !== true) {
                    event.preventDefault();
                    ...
                    var $button = $(this);
                        ...
                        $(document).on('change', '#file', function(){
                            var numero = $($button).closest('tr').find('.haenumero').text();
